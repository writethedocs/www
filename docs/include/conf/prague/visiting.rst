...
Prague's `Vaclav Havel airport <https://www.prg.aero/en/>`__ provides many direct and low-cost flights with airlines such as Czech Airlines, Ryanair, Wizz Air, Air Berlin, Norwegian... You get the idea.
...
You can even take a train from Denmark `inside a ferry! <https://en.wikipedia.org/wiki/Vogelfluglinie>`__
...
The biggest Czech bus company `Student Agency <https://www.studentagency.eu/>`__ operates direct bus lines between Prague and cities like Berlin, Vienna, Zagreb, Munich, etc.
Global companies like `Eurolines <https://www.eurolines.com/en/>`__ operate direct lines to many European cities.
...
The `Prague Public Transit Co. <https://www.dpp.cz/en/>`__ runs an extensive network of trams, buses, and 3 metro lines.
...
Depending on where you are staying, these bus lines will connect you to several major metro stations as well as the main train station. `More information on airport transfers. <https://www.dpp.cz/en/public-transit-to-prague-airport/>`__
...
-  `AAA Taxi <https://www.aaataxi.cz/en/>`__
-  `Tick Tack <https://www.ticktack.cz/en>`__
...
-  `Booking.com <https://www.booking.com/>`__
-  `Hotels.com <https://www.hotels.com/>`__
