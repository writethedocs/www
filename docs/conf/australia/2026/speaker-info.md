...
For example, if you speak Friday afternoon, your tech will be during the lunch hour on Friday. We'll send a calendar invite with your exact tech time. You're also welcome to attend an earlier tech check (for example, on Thursday), if you'd prefer to get it out of the way.
