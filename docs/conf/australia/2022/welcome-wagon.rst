...
`Writing Day <https://www.writethedocs.org/conf/{{ shortcode }}/{{ year }}/writing-day/>`__ takes place both conference day mornings, for a few hours before the conference talks are scheduled.
