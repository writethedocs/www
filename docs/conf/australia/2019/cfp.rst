...
:banner: _static/conf/images/headers/au-speakers.jpg
...
Mini-workshop will be scheduled in 1 hour blocks. This mini-workshop can be around anything to do with documentation.
