...
Write the Docs {{cookiecutter.city}} {{cookiecutter.year}} Sponsorship
#####################################################################
...
and credibility with front-line documentarians, but also valuable insights that
will help you get the most out of your own documentation efforts. If you're
hiring for docs positions, Write the Docs is also an excellent opportunity to
meet top-notch talent.
...
These package prices apply to the {{cookiecutter.year}} {{cookiecutter.continent}} conference only. Ask us about discounted packages for sponsoring both conferences.
...
The **First Draft** package costs **TODO:**.
You can buy it directly on our `ticket website <TODO:>`_
...
The **Second Draft** package costs **TODO:**.
...
The **Publisher** package costs **TODO:**.
...
The **Keystone** package costs **TODO:**.
