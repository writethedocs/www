...
* **Slack with your fellow documentarians.** Our `Slack <https://slack.writethedocs.org/>`_ is the place to coordinate dinners, ask questions, or share notes with fellow conference attendees. Please use the **#wtd-conferences** or **#prague** channels for group discussions.
