...
If you need to cancel your ticket because of fear of traveling internationally or getting COVID-19 prior to the conference, we will offer a 100% refund.
...
<div class="ticket">
  ...
  <p>
    We provide a certificate of attendance on request after the conference. Email us at <a href="mailto:{{email}}">{{email}}</a> and we will send you one.
  </p>
  {% if flagticketsonsale %}
  <ul>
    <li>
