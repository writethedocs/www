...
::
   ...
   * [Talk recording upload]({{cfp_variables['upload']}})
   ...
   And while we're here, 😉 if you don't have a profile picture set in [Pretalx](https://pretalx.com/write-the-docs-portland-2022/login/), now would be a great time to add one, and to fill out the questions on pronouns, name pronunciation and interests for our emcee intro.
