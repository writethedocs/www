...
We're thrilled to announce that `tickets are now available for Write the Docs Portland 2026 <https://www.writethedocs.org/conf/{{shortcode}}/{{year}}/tickets/>`_!
...
Visit our `Opportunity Grants page <https://www.writethedocs.org/conf/{{shortcode}}/{{year}}/opportunity-grants/>`_ for more information, or click here to apply:
...
Visit our `Volunteer page <https://www.writethedocs.org/conf/{{shortcode}}/{{year}}/volunteer/>`_ to learn more, or click here to sign up:
