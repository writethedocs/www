...
-  Portland is a very walk-able town. Most of the events and `the suggested hotels <https://www.writethedocs.org/conf/portland/2018/visiting/>`__ are within walking distance of the conference venue, the Crystal Ballroom.

-  There are good public transportation options and taxi services. Check out the `Visiting Portland section of the Write the Docs website <https://www.writethedocs.org/conf/portland/2018/visiting/>`__ for more info.
...
-  If you are going on the `Write the Docs hike on Saturday <https://www.writethedocs.org/conf/portland/2018/hike/>`__, be sure
...
-  The unconference is a set of informal sessions that take place below the Crystal Ballroom in Lola's Room on Monday and Tuesday afternoons. `Unconference talks focus on exchanges of ideas between participants. <https://www.writethedocs.org/conf/portland/2018/unconference/>`__
...
-  If you are interested in giving a lightning talk, be prepared! There is a great guide `here <https://www.writethedocs.org/conf/portland/2018/lightning-talks/?highlight=re>`__.
...
-  Find out who is attending the conference before you get there. Join the `Write the Docs Slack <https://www.writethedocs.org/slack/>`__, follow the `Write the Docs on Twitter <https://twitter.com/writethedocs>`__,
...
-  Join the `Write the Docs Slack <https://www.writethedocs.org/slack/>`__, and participate in the Welcome Wagon chat room to start making conference connections.
