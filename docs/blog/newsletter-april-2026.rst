...
As AI has developed, new challenges have emerged for documentarians. A discussion in `#doctools <https://writethedocs.slack.com/archives/C4EPE8332>`__ focused on a possible opportunity: whether to use AI to build a custom documentation platform instead of using an existing solution. 
...
See more Write the Docs resources about `choosing tools for documentation </guide/choosing-tools/>`__, `doc tools </topics/#doc-tools>`__, and `AI and LLMs <https://www.writethedocs.org/topics/#ai-and-llms>`__.
...
This month’s newsletter is sponsored by `Inkstone <https://app.inkstone.pro/signup?code=prm_t4GeIUXeaK>`_.

.. image:: /_static/img/sponsors/inkstone.png
  :align: center
  :width: 50%
  :target: https://app.inkstone.pro/signup?code=prm_t4GeIUXeaK
  :alt: Inkstone logo

You don't have a writing problem. You have a tab problem. Research here. Draft there. Proofread in tool 3. Fact-check in tool 4. Inkstone puts all of it on the same surface where you write. Deep research, web search, proofreading, and fact-checking, built right into the editor. Even claim verification, inline, as you work. No other writing tool does that.

And here's the best part: nothing touches your docs without your say. Every AI suggestion, whether it's flagging a term that conflicts with your style guide or catching an inconsistency across your API descriptions, appears as a tracked change. Accept or reject. It's the sharp technical editor that never overwrites you. Your call, every time. `Try Inkstone → <https://app.inkstone.pro/signup?code=prm_t4GeIUXeaK>`__
...
`Technical SEO Content Engineer/Docs Writer (SaaS / Developer Docs) <https://nalpeiron-inc.breezy.hr/p/a3b65b26c8e5-technical-seo-content-engineer-saas-developer-docs-remote>`__, Nalpeiron - *Contractor Remote*
...
- 3 Apr, 08:30 EDT (US East Coast Virtual): `Social Hour for Documentarians <https://www.meetup.com/write-the-docs-east-coast/events/312057453/>`__
- 12 Apr, 10:00 EDT (USA): `Write the Docs Carolinas Social Hike @ Bass Lake <https://www.meetup.com/write-the-docs-carolinas/events/313742454/>`__
- 14 Apr, 17:30 MDT (Calgary, Canada): `Write the Docs Calgary Coffee Night <https://www.meetup.com/wtd-calgary/events/312192011/>`__
- 15 Apr, 18:00 CEST (Barcelona, Spain): `API Docs - Latest Trends <https://www.meetup.com/write-the-docs-barcelona/events/314051201/>`__
- 16 Apr, 18:30 BST (London, United Kingdom): `Writing for and with AI <https://www.meetup.com/write-the-docs-london/events/313617430/>`__
- 16 Apr, 18:00 PDT (San Francisco, USA): `The Future of Developer Experience: Documentation, AI, and APIs <https://www.meetup.com/write-the-docs-bay-area/events/313391126/>`__
- 17 Apr, 08:30 EDT (US East Coast Virtual): `Write the Docs East Coast Virtual Meetup <https://www.meetup.com/write-the-docs-east-coast/events/311760886/>`__
- 21 Apr, 17:00 EDT (New York City, USA): `Pre-WTD Happy Hour <https://www.meetup.com/writethedocsnyc/events/313965080/>`__
- 22 Apr, 18:30 PDT (Portland, USA): `Live and In-Person! AI Tools & Workflows <https://www.meetup.com/write-the-docs-pdx/events/313885774/>`__
- 1 May, 08:30 EDT (US East Coast Virtual): `Write the Docs East Coast Virtual Meetup <https://www.meetup.com/write-the-docs-east-coast/events/311760887/>`__
- 7 May, 17:30 PDT (San Francisco, USA): `State of the Docs Panel Sponsored by Gitbook <https://www.meetup.com/write-the-docs-bay-area/events/312803329/>`__
