...
We're proud of the work our teams are doing,
and the spaces we're able to create.

However, the industry is in a state of tumult.
...
Write the Docs started with a conference [13 years](https://www.writethedocs.org/origin-story/) ago.
Conferences are the heart of the organization,
and where the funding for everything else we do comes from.
Our [Core Operations team](https://www.writethedocs.org/team/#core-operations-coreops) and event producer help organize the Portland and Berlin conferences.
Almost everything else is done by volunteers -- people who want to build community and connect with others.
...
That is a continuing theme of everything that we do,
and we are always looking for other avenues to support the community in that way.
...
Thanks to everyone who has contributed to the community this year.
From the Meetup organizers hosting events after work,
to the folks in Slack posting jobs,
