...
Two bits and pieces for you on the news front today. In December we annouced dates for the Prague conference, which will be 13-15 September - and in a brand shiny new venue, the Hotel Olšanka! `Read all about it here </conf/prague/2020/news/init/>`__. As for across the pond, the speakers for Portland speakers will be announced soon, so keep your eyes peeled for those. The conference is 3-5 May, and `tickets are on sale right now </conf/portland/2020/tickets/>`__.
...
There's been a buzz of activity all through January in the `#learn-tech-writing <https://app.slack.com/client/T0299N2DL/C7YJR1N02>`__ channel, where folks have been discussing *The Product is Docs* chapter-by-chapter. As those involved have kindly started an effort to write up all the fantastic conversations on the topic, we're not going to write it up in the newsletter, but we wanted to point you towards what's been written up so far:
...
--------------------------------------
How to set priorities in documentation
--------------------------------------
...
----------------------------------------------
Dealing with finding inaccuracies in your docs
----------------------------------------------
...
The question of blame is unavoidable. Should writers have their work scrutinized for small errors? Many felt problems in documentation should rather be attributed to process failure. If you have to complete a document in a limited time, the pressure of the crunch can result in not enough time to check, and thereby faulty docs. Others didn't want to frame it as a failure: just a chance to improve both the doc and processes. But even if you have a good pre-publication process, errors may arise from other factors: for example, testing the docs but within the wrong environment, meaning they don't match the end user experience.

What most agreed on is that the documentation should be revised and corrected as soon as any errors are discovered. If errors are a big problem, teams can establish a process of reviews and approvals to check for accuracy. Another option suggested was be to have a QA function test the documentation.
...
- 03 February - London, UK - `Documenting your APIs with Postman <https://www.meetup.com/Write-The-Docs-London/events/268166200/>`__
- 03 February - Portland, OR, USA - `Knowledge-Centered Support (joint meetup with Support Driven) <https://www.meetup.com/Write-The-Docs-PDX/events/267740062/>`__
