...
cat ~/Downloads/Write\ the\ Docs\ Portland\ 2017\ Schedules\ -\ Main\ Filled.csv |csvcut -x -c 1,2 | head -n 25 |csvjson -i 4 > ../_data/na-2017-day-1.json
cat ~/Downloads/Write\ the\ Docs\ Portland\ 2017\ Schedules\ -\ Main\ Filled.csv |csvcut -x -c 1,2 | tail -n 20 |csvjson -i 4 > ../_data/na-2017-day-2.json
