...
.. STYLE: dropdown for previous salary survey results menu

.. STYLE: current menu section and sub-sections: make them clearer - what about automatically updating as you scroll?

.. IDEA: work out how to implement the nav menu on mobile - hamburger?

.. IDEA: make hidden sort column in tables
...
.. STYLE: add survey-only newsletter signup form 
...
.. IDEA: use JS to add sort order data attribute to time in current role/time contracting tables
...
.. TABLE: median salary by respondent region 
...
.. TABLE: median salary by organization size
...
.. TABLE: individuals with both statutory and eqiuvalent extra benefit i.e. vacation plus extra, healthcare plus extra  
