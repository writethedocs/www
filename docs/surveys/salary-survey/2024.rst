...
.. IDEA: current menu section and sub-sections: make them clearer - what about automatically updating as you scroll?

.. IDEA: work out how to implement the nav menu on mobile - hamburger?

.. IDEA: try alternative table sorting library that works with hidden sort columns
...
.. IDEA: add survey-only newsletter signup form 
...
This sixth incarnation of the Write the Docs Salary Survey drew 779 responses, from documentarians in 55 countries. As always, we are impressed by the skills, experience and diversity of the Write the Docs community, and are grateful to everyone who took the time to fill out the survey and share it with their co-workers. Without further ado, let's look at the findings!
...
.. table:: Top role category combinations
   :widths: 90 10
   :name: tbl-2024-top-category-combinations
   :class: no-sort
   ...
   +-----------------------------------------+-----+
   | **Primary: Project or product manager**       |
   +-----------------------------------------+-----+
   | - Technical writer                      |  11 |
   +-----------------------------------------+-----+
   | - Manager or team leader                |  10 |
   +-----------------------------------------+-----+
   | - Editor                                |   7 |
   +-----------------------------------------+-----+
...
.. CHART: proportion of role; actual portion vs official portion

.. raw:: html

   <figure>
      <object role="img" aria-label="Portion of role officially documentation-related" aria-describedby="figure_proportion-of-role-officially-docs-related_desc" type="image/svg+xml" data="/_images/2024-portion-of-role-officially-docs-related.svg">
...
.. raw:: html
   ...
   <div class="tab-wrap"><input type="radio" id="tabD603-1" name="tabGroupD603" class="tab" checked><label for="tabD603-1">Statutory benefits</label><input type="radio" id="tabD603-2" name="tabGroupD603" class="tab"><label for="tabD603-2">Extra statutory benefits</label><input type="radio" id="tabD603-3" name="tabGroupD603" class="tab"><label for="tabD603-3">Non-statutory benefits</label><div class="tab__content">
...
.. raw:: html
   ...
   <div class="tab-wrap"><input type="radio" id="tabF1a-1" name="tabGroupF1a" class="tab" checked><label for="tabF1a-1">Salary satisfaction</label><input type="radio" id="tabF1a-2" name="tabGroupF1a" class="tab"><label for="tabF1a-2">Overall satisfaction</label><div class="tab__content">
...
.. table:: Satisfaction statements - salary and benefits
   ...
   +----------------------------------------------------+----------+---------+----------+--------------+
   | Statements                                         | Positive | Neutral | Negative | Irrelevant   |
   +====================================================+==========+=========+==========+==============+
   | I'm paid fairly                                    |    67.0% |   16.1% |    16.8% |         0.0% |
   +----------------------------------------------------+----------+---------+----------+--------------+
   | My salary keeps up with inflation / cost-of-living |    42.2% |   22.6% |    32.6% |         0.7% |
   +----------------------------------------------------+----------+---------+----------+--------------+
   | My benefits are sufficient                         |    68.9% |   17.8% |    13.4% |         0.0% |
   +----------------------------------------------------+----------+---------+----------+--------------+
...
.. table:: Satisfaction statements - job
   ...
   | Statements                                        | Positive | Neutral | Negative | Irrelevant |
   +===================================================+==========+=========+==========+============+
   | My hours are reasonable                           |    88.0% |    7.4% |     4.5% |       0.0% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | I have flexibility in my hours                    |    91.7% |    4.5% |     3.8% |       0.0% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | My responsibilities are reasonable                |    79.1% |   11.5% |     9.4% |       0.0% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | My workload is manageable                         |    69.6% |   16.1% |    14.2% |       0.1% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | I have opportunities for career advancement       |    43.7% |   27.6% |    27.6% |       1.0% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | I have opportunities for professional development |    62.7% |   20.5% |    16.3% |       0.6% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | My work is sufficiently interesting/challenging   |    73.3% |   17.0% |     9.7% |       0.0% |
   +---------------------------------------------------+----------+---------+----------+------------+
   | I’m satisfied with the systems and toolsets I use |    60.9% |   20.6% |    18.3% |       0.1% |
   +---------------------------------------------------+----------+---------+----------+------------+
...
.. table:: Satisfaction statements - workplace
   ...
   | Statements                                                  | Positive | Neutral | Negative | Irrelevant |
   +=============================================================+==========+=========+==========+============+
   | I have flexibility in my work location                      |    79.6% |    6.5% |    11.0% |       2.8% |
   +-------------------------------------------------------------+----------+---------+----------+------------+
   | Our remote work systems, tools and practices function well  |    83.9% |    8.8% |     3.7% |       3.6% |
   +-------------------------------------------------------------+----------+---------+----------+------------+
   | Our on-site work systems, tools and practices function well |    52.0% |   11.9% |     5.5% |      30.6% |
   +-------------------------------------------------------------+----------+---------+----------+------------+
   | Our hybrid work systems, tools and practices function well  |    53.6% |   11.1% |     4.6% |      30.7% |
   +-------------------------------------------------------------+----------+---------+----------+------------+
...
.. table:: Satisfaction statements - team and organization
   ...
   | Statements                                                    | Positive | Neutral | Negative | Irrelevant |
   +===============================================================+==========+=========+==========+============+
   | To my knowledge, salaries are consistent across similar roles |    40.4% |   33.2% |    19.2% |       7.2% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
   | To my knowledge, all genders are paid equally                 |    51.9% |   30.9% |    12.8% |       4.5% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
   | My role is sufficiently valued/funded                         |    52.9% |   20.1% |    26.8% |       0.3% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
   | I like and/or respect my managers and team leaders            |    79.5% |   11.9% |     8.1% |       0.4% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
   | I like and/or respect my co-workers                           |    91.7% |    6.2% |     1.6% |       0.6% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
   | I like and/or respect my organization                         |    66.9% |   22.2% |    10.4% |       0.6% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
   | I’m satisfied with our methodologies, systems and practices   |    49.9% |   25.1% |    24.6% |       0.4% |
   +---------------------------------------------------------------+----------+---------+----------+------------+
...
.. raw:: html
   ...
   <div class="tab-wrap"><input type="radio" id="tabA113-1" name="tabGroupA113" class="tab" checked tabindex="0"><label for="tabA113-1">Type of client</label><input type="radio" id="tabA113-2" name="tabGroupA113" class="tab"><label for="tabA113-2">Contract length</label><input type="radio" id="tabA113-3" name="tabGroupA113" class="tab"><label for="tabA113-3">Products and services</label><div class="tab__content">

.. table:: Contractor type - type of client
   :widths: 70 15 15
...
.. table:: Contractor type - contract length
   :widths: 70 15 15
...
.. table:: Contractor type - products and services
   :widths: 70 15 15
...
.. WRITE: 94 contractor rates entered - breakdown by type
...
.. table:: Currencies and exchange rates - contractors
   :widths: 70 15 15 
   :name: tbl-2024-currencies-exchange-rates-contractors
   :class: sortable tbl_currency

   +-----------------------------------+------------+--------+--------+
   | Currency (code)                   | Rate       | |N|    | |%|    |
   +===================================+============+========+========+
   | United States Dollar (USD)        | 1          | 56     |  59.6% |
   +-----------------------------------+------------+--------+--------+
...
.. raw:: html
   ...
   <div class="tab-wrap"><input type="radio" id="tabF1b-1" name="tabGroupF1b" class="tab" checked><label for="tabF1b-1">Earnings satisfaction</label><input type="radio" id="tabF1b-2" name="tabGroupF1b" class="tab"><label for="tabF1b-2">Overall satisfaction</label><div class="tab__content">

.. table:: Earnings satisfaction - contractors
   :widths: 70 15 15
   :name: tbl-2024-earnings-satisfaction-contractors
   :class: std3col sortable

   +---------------------------+--------+--------+
   | Earnings satisfaction     | |N|    | |%|    |
   +===========================+========+========+
   | Satisfied                 | 40     | 42.6%  |
   +---------------------------+--------+--------+
