...
Repeat survey participants - 50% of the 2025 respondents - may have noticed that the survey form was shorter. The sections which were removed were those which had previously generated interesting and relevant results, but which - due to evolving workplace norms - no longer seemed relevant in 2025. In the interests of keeping the survey length manageable and the focus on factors that more directly affect salary, these sections were removed. They were:

1. **Work location**: In our first salary survey - 2019, before the pandemic - work location was a single question and over half of respondents worked from an on-site office location. By the time of the 2020 survey, after COVID-19 hit - "work from home" had become the norm for 87.7%, and new questions revealed how we felt about this shift. By 2022 there was already debate about whether so many questions about pandemic-related workplace changes were necessary, but the beginnings of "return to the office mandates" and the rise of hybrid working modes meant that we continued to discuss this into 2023. The 2024 results revealed trends and attitudes that were becoming predictable: most people worked remotely or hybrid, most people preferred these modes, and most peole affected by "return to office" mandates were not particularly happy about it. It also became apparent that this was the new normal, and keeping these questions in the survey was unlikely to reveal any new trends or changes. 

2. **Employee benefits**: Write the Docs is a global community and the greatly varying labour laws and conditions around the world has made employee benefits a difficult area to survey. We experimented with several different question formats for benefits, but with no way to compare "like for like", there's no way to determine how benefits impact salary.   
...
.. container:: note
   ...
   Several year-over-year patterns emerged in the 2025 results. Median employee salaries by region were moderately higher in 2025, with increases worldwide, in North America, and in Europe. At the same time, employee salary satisfaction and overall satisfaction both declined, respondents were more likely to report feeling less secure in their jobs, and a larger share were not working at the time of the survey.
...
.. raw:: html
      ...
      <figure>
         <object role="img" aria-label="Salary (USD) by education level" aria-describedby="figure_salary-by-education_desc" type="image/svg+xml" data="/_images/2025-salary-by-education-v2.svg">
            <p id="figure_salary-by-education_desc">Median salary chart showing worldwide salary by education level, with percentile ranges where sample sizes support them and median-only markers for smaller groups. Undergraduate has the highest worldwide median at about $99,000.</p>
         </object>
...
.. raw:: html
      ...
      <figure>
         <object role="img" aria-label="Salary (USD) by education level — Europe" aria-describedby="figure_salary-by-education-eu_desc" type="image/svg+xml" data="/_images/2025-salary-by-education-eu-v2.svg">
            <p id="figure_salary-by-education-eu_desc">Median salary chart showing European salary by education level, with percentile ranges for undergraduate and postgraduate respondents and a median-only marker for multiple postgraduate respondents. Postgraduate is slightly higher than undergraduate.</p>
         </object>
