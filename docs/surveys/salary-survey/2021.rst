...
.. raw:: html
   ...
   <figure>
      <object role="img" aria-label="Hours worked - employees and contractors (2021)" aria-describedby="figure-hours-employees_desc" type="image/svg+xml" data="/_images/2021-placeholder-chart.svg">
         <p id="figure-hours-employees_desc">Bar chart showing weekly hours worked by employee respondents only</p>
      </object> 
      <figcaption>Figure: Hours worked - employees only (2021)</figcaption>
   </figure>
...
.. raw:: html
   ...
   <figure>
      <object role="img" aria-label="Job title word cloud (2021)" aria-describedby="figure-job-title_desc" type="image/svg+xml" data="/_images/2021-placeholder-chart.svg">
         <p id="figure-job-title_desc">Word cloud showing terms used in job titles, sized proportionately to the number of occurences of each.</p>
      </object> 
...
.. table:: Currencies and exchange rates (to 1 USD)
   ...
   +------------------------+------+-----------+-------------+---------------+
   | Brazillian Real        | BRL  |     1     |      --     |      0.185533 |
   +------------------------+------+-----------+-------------+---------------+
...
Section 1: Organization demographics
====================================
