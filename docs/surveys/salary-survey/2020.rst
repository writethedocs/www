...
805 people completed the survey in 2020, an increase of24% over 2019.
...
.. container:: c85
   ...
   `[a] <#cmnt_ref1>`__\ I don't want to label this "Middle East"
   because Israel is the only country we have responses from ...
   footnote perhaps?

.. container:: c85

   `[b] <#cmnt_ref2>`__\ Should we include this? 3 salaries is too low
   to post a median, but leaving it out completely seems dismissive
