...
.. |tab-between| raw:: html

   </div><div class="tab__content">

.. |tabgroup-end| raw:: html

   </div></div>

.. |hscroll-start| raw:: html

   <div class="tablescroller">

.. |hscroll-end| raw:: html
...
.. table:: Team breakdown
   ...
   +--------------------------------------------------------------------------------------+-----+-------+
   | Solo worker, Team - similar roles, Team - different roles                            | 19  | 1.9%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Team - different roles, Manager or team leader                                       | 16  | 1.6%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Solo worker, Team - similar roles                                                    | 15  | 1.5%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Solo worker, Team - similar roles, Team - different roles, Multiple teams            | 14  | 1.4%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Team - similar roles, Team - different roles, Multiple teams, Manager or team leader | 13  | 1.3%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Solo worker, Multiple teams                                                          | 12  | 1.2%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Solo worker, Manager or team leader                                                  | 10  | 1.0%  |
   +--------------------------------------------------------------------------------------+-----+-------+
   | Team - different roles, Multiple teams, Manager or team leader                       | 10  | 1.0%  |
   +--------------------------------------------------------------------------------------+-----+-------+
...
.. raw:: html
   ...
   <figure>
      <object role="img" aria-label="Length of time in current role" aria-describedby="figure_length-of-time-in-current-role_desc" type="image/svg+xml" data="/_images/2023-placeholder.svg">
         <p id="figure_length-of-time-in-current-role_desc">Length of time in current role (at current organization - respondents who have changed roles at the same organization were instructed to specify the length of time they had been in their current role only, not the total length of time at the organization)</p>
      </object> 
      <figcaption>Figure: Length of time in current role</figcaption>
   </figure>

.. figure:: images/2023/2023-placeholder.svg
   :class: hide
...
The majority of respondents - 46.3% of employees and 38% of contractors - stated that while they were not actively looking for new positions or contracts, they were open to any offers that might come their way. 14% of employees and 29.1% of contractors said they were actively looking for new work. 
...
.. table:: Current job search status - employees
   ...
   +--------------------------------------------------------+-----+-------+
   | Actively looking                                       | 131 | 14%   |
   +--------------------------------------------------------+-----+-------+
   | Not looking yet, but expect to be within the next year | 75  | 8%    |
   +--------------------------------------------------------+-----+-------+
...
.. table:: Feelings of job security and stability - employees and contractors combined
   :widths: 70 15 15
   :name: tbl-2023-feelings-of-job-security-combined

   +----------------------------------------+-----+-------+
   | Feelings of job security and stability | No. | %     |
   +========================================+=====+=======+
...
.. table:: Work location
   ...
   | Hybrid                | 287 | 28.2% |
   +-----------------------+-----+-------+
   | Onsite (not required) | 35  | 3.4%  |
   +-----------------------+-----+-------+
   | Onsite (required)     | 32  | 3.1%  |
   +-----------------------+-----+-------+
...
.. table:: Feelings about work location
   ...
   +------------------------------+-----+-------+
   | Feelings about work location | No. | %     |
   +==============================+=====+=======+
...
55.1% of respondents reported that they have not been affected by "return to the office" policies. 42.8% have been affected, with only 2.2% unsure. 
...
.. table:: Not affected by "return to the office" mandates
   :widths: 70 15 15
   :name: tbl-2023-return-to-the-office-mandates-not-affected

   +------------------------------------------------------+-----+-------+
   | Return to the office mandate status                  | No. | %     |
   +======================================================+=====+=======+
...
.. table:: Affected by "return to the office" mandates -
   :widths: 70 15 15
...
Those who reported being affected by a "return to the office" policy were asked about their feelings on the situation. 
...
Those affected by a full time return to the office mandate felt predominantly negative, with only 3 individuals reporting positive feelings. 
...
With this year's survey amassing the highest number of submissions yet, we can now provide a more extensive range of salary breakdowns. Alongside the baseline data for Africa, which encompasses respondents from South Africa, Kenya, and Nigeria, we have gathered enough data to publish medians for 15 individual countries, 17 US states, 3 Canadian provinces (including separate figures for each province's capital city), and 3 Australian states.

In regions or categories meet the minimum threshold of 30 respondents, we're also providing the 25th percentile (the value below which 25% of the data falls) and 75th percentile (the value below which 75% of the data falls) figures.

Currency, pay interval and salary
---------------------------------
...
.. container:: question
   ...
   What is your total (gross) salary (including tax)? Note: If your total compensation is made up of a base salary and significant bonus, equity or commission payments, please enter your total compensation here (or an average, if it fluctuates).
...
.. table:: Currencies and exchange rates - employees
   ...
   +=============================+======+=====+=======+=========+
   | United States Dollar        | USD  | 487 | 51.9% | 1       |
   +-----------------------------+------+-----+-------+---------+
   | Euro                        | EUR  | 147 | 15.7% | 1.08396 |
   +-----------------------------+------+-----+-------+---------+
   | Canadian Dollar             | CAD  | 73  | 7.8%  | 0.74068 |
   +-----------------------------+------+-----+-------+---------+
   | British Pound Sterling      | GBP  | 55  | 5.9%  | 1.25209 |
   +-----------------------------+------+-----+-------+---------+
   | Australian Dollar           | AUD  | 41  | 4.4%  | 0.65884 |
   +-----------------------------+------+-----+-------+---------+
   | Indian Rupee                | INR  | 27  | 2.9%  | 0.01209 |
   +-----------------------------+------+-----+-------+---------+
   | Romanian Leu                | RON  | 17  | 1.8%  | 0.23    |
   +-----------------------------+------+-----+-------+---------+
   | Polish Zloty                | PLN  | 13  | 1.4%  | 0.24198 |
   +-----------------------------+------+-----+-------+---------+
   | Russian Ruble               | RUB  | 12  | 1.3%  | 0.0119  |
   +-----------------------------+------+-----+-------+---------+
   | Israeli New Shekel          | NIS  | 12  | 1.3%  | 0.26921 |
   +-----------------------------+------+-----+-------+---------+
   | Czech Koruna                | CZK  | 8   | 0.9%  | 0.04484 |
   +-----------------------------+------+-----+-------+---------+
   | South African Rand          | ZAR  | 7   | 0.7%  | 0.05359 |
   +-----------------------------+------+-----+-------+---------+
   | Ukrainian Hryvnia           | UAH  | 6   | 0.6%  | 0.0272  |
   +-----------------------------+------+-----+-------+---------+
   | Mexican Peso                | MXN  | 5   | 0.5%  | 0.05734 |
   +-----------------------------+------+-----+-------+---------+
   | Japanese Yen                | JPY  | 5   | 0.5%  | 0.007   |
   +-----------------------------+------+-----+-------+---------+
   | Brazilian Real              | BRL  | 4   | 0.4%  | 0.2003  |
   +-----------------------------+------+-----+-------+---------+
   | New Zealand Dollar          | NZD  | 4   | 0.4%  | 0.61072 |
   +-----------------------------+------+-----+-------+---------+
   | Swedish Krona               | SEK  | 4   | 0.4%  | 0.09427 |
   +-----------------------------+------+-----+-------+---------+
   | Swiss Franc                 | CHF  | 4   | 0.4%  | 1.12614 |
   +-----------------------------+------+-----+-------+---------+
   | Norwegian Krone             | NOK  | 1   | 0.1%  | 0.09413 |
   +-----------------------------+------+-----+-------+---------+
   | United Arab Emirates Dirham | AED  | 1   | 0.1%  | 0.27227 |
   +-----------------------------+------+-----+-------+---------+
   | Indonesian Rupiah           | IDR  | 1   | 0.1%  | 0.00007 |
   +-----------------------------+------+-----+-------+---------+
   | Kenyan Shilling             | KES  | 1   | 0.1%  | 0.0072  |
   +-----------------------------+------+-----+-------+---------+
   | Thai Baht                   | THB  | 1   | 0.1%  | 0.02851 |
   +-----------------------------+------+-----+-------+---------+
   | Singapore Dollar            | SGD  | 1   | 0.1%  | 0.74368 |
   +-----------------------------+------+-----+-------+---------+
   | Danish Krone                | DKK  | 1   | 0.1%  | 0.14532 |
   +-----------------------------+------+-----+-------+---------+
...
The median salary for all regions combined in 2023 was USD $82,418 (meaning that half of all respondents earned more, and half earned less). This is the highest overall median reported since the survey began. 

The 25th percentile salary for all regions was USD $58,534 and the 75th percentile salary was USD $118,571. 
...
.. table:: Median salary (USD) by respondent region
   :name: tbl-2023-median-salary-by-respondent-region

   +-------------------+---------+-------------+--------------+--------------+
   | Region            | No.     | 25th %ile   | Median       | 75th %ile    |
   +===================+=========+=============+==============+==============+
...
37 US states were represented in the results. Of these, 17 had more than the minimum 10 respondents required to calculate a state-based median salary. Where possible, major city breakdowns are also provided. For the first time, the 2024 results included enough Canadian-based respondents to publish median salaries, for three provinces and three major cities as well as the country overall. Also for the first time, the 2024 results included enough Australian respondents to publish median salaries for three states. 
...
.. table:: Median salary (USD) by respondent region - US state
   :name: tbl-2023-median-salary-by-respondent-region-us-state

   +-----------------+-----+-----------+----------+-----------+
   | State           | No. | 25th %ile | Median   | 75th %ile |
   +=================+=====+===========+==========+===========+
   | California      |  65 |  $100,995 | $149,347 |  $180,000 |
   +-----------------+-----+-----------+----------+-----------+
   | - San Francisco |  10 |           | $200,000 |           |
   +-----------------+-----+-----------+----------+-----------+
...
.. table:: Median salary (USD) by respondent region - Canadian province
   :name: tbl-2023-median-salary-by-respondent-region-canadian-province

   +------------------+-----+-----------+---------+-----------+
   | Province         | No. | 25th %ile | Median  | 75th %ile |
   +==================+=====+===========+=========+===========+
...
.. table:: Median salary (USD) by respondent region - Australian state
   :name: tbl-2023-median-salary-by-respondent-region-australian-state
...
.. table:: Employee benefits
   ...
   +----------------------------------------------------------------------------+------+-------+
   | Pension, superannuation, 401(k) matching or retirement fund *              | 536  | 57.1% |
   +----------------------------------------------------------------------------+------+-------+
...
As a result of 5 submissions in the "other" category, a new factor was added, "No raises or adjustments for inflation". It's worth noting that had this option been included in the question, other respondents may have selected it, so it's possible that this factor is affecting the industry more than these results would suggest.
...
\* A new factor, added as a result of multiple submissions in the "other" category
...
.. table:: Factors affecting employee job satisfaction
   ...
   +-------------------------------------------------------------------------------------+-----+-------+
   | I am discriminated against for some othe reason, or a reason I do not wish to share | 10  | 1.1%  |
   +-------------------------------------------------------------------------------------+-----+-------+
...
.. table:: Factors enhancing employee job satisfaction
   ...
   | Factor                                                                                             | No. | %   |
   +====================================================================================================+=====+=====+
   | I like and/or respect my co-workers                                                                | 794 | 85% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I have flexibility in working hours or location                                                    | 673 | 72% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | My manager's expectations are realistic/reasonable                                                 | 610 | 65% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I feel I have work-life balance                                                                    | 608 | 65% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | My workload is manageable                                                                          | 584 | 62% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | The work is sufficiently interesting and/or challenging                                            | 558 | 60% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I'm satisfied with my benefits                                                                     | 511 | 55% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I'm compensated fairly for the work I do                                                           | 499 | 53% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I like and/or respect the organization I work for                                                  | 494 | 53% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | My contributions are valued                                                                        | 466 | 50% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I feel respected                                                                                   | 456 | 49% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I feel I am making a positive impact (in my organization, industry, community, or the wider world) | 411 | 44% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
   | I have opportunities for career development and advancement                                        | 252 | 27% |
   +----------------------------------------------------------------------------------------------------+-----+-----+
...
48% of contractor clients indicated that they worked exclusively for a single client at a time. Another 34% indicated that they worked exclusively for multiple clients at a time. 13% worked worked at times for either a single client or multiple clients, and 5% did not indicate whether they worked for a single client or multiple. 
...
.. table:: Contractor work type - clients
   ...
   | Single client                    |  38 | 48% |
   +----------------------------------+-----+-----+
   | Multiple clients                 |  27 | 34% |
   +----------------------------------+-----+-----+
   | Both single and multiple clients |  10 | 13% |
   +----------------------------------+-----+-----+
   | Not specified                    |   4 |  5% |
   +----------------------------------+-----+-----+
...
.. table:: Contractor work type - products and services
   ...
   +-----------------------------------------------------+------+-------+
   | Product or service offering                         | No.  | %     |
   +=====================================================+======+=======+
...
.. table:: Currencies and exchange rates - contractors
   ...
   | Currency                     | No. | %     | Rate    |
   +==============================+=====+=======+=========+
   | United States Dollar (USD)   | 44  | 55.7% |       1 |
   +------------------------------+-----+-------+---------+
   | Euro (EUR)                   | 15  | 19.0% | 1.08396 |
   +------------------------------+-----+-------+---------+
   | Canadian Dollar (CAD)        | 7   | 8.9%  | 0.74068 |
   +------------------------------+-----+-------+---------+
   | Australian Dollar (AUD)      | 5   | 6.3%  | 0.65884 |
   +------------------------------+-----+-------+---------+
   | British Pound Sterling (GBP) | 5   | 6.3%  | 1.25209 |
   +------------------------------+-----+-------+---------+
   | Ukrainian Hryvnia (UAH)      | 2   | 2.5%  |  0.0272 |
   +------------------------------+-----+-------+---------+
   | Polish Zloty (PLN)           | 1   | 1.3%  | 0.24198 |
   +------------------------------+-----+-------+---------+
...
.. table:: Factors affecting overall satisfaction - contractors
   ...
   +-------------------------------------------------------------------------------------+-----+------+
   | I am discriminated against for some othe reason, or a reason I do not wish to share | 2   | 0.8% |
   +-------------------------------------------------------------------------------------+-----+------+
...
.. container:: note
   ...
   A number of US states have made some level of pay transparency law - Maryland, Colorado, Connecticut, Nevada, Rhode Island, Washington, California and New York - and a number of others are considering doing so. The exact requirements, level of compliance and enforcement mechanisms vary from state to state, and as most laws have only been enacted recently, it will take some time for the effects to be felt.

   Additionally, The European Parliament approved a new Pay Transparency Directive in March 2023. EU member states have three years to enact legislation based on the directive. Part of the directive involves measuring and eliminating any gender-based pay discrepencies. 

   TODO: add links to more info
...
.. table:: Pay transparency policy
   ...
   +----------------------------------+-----+-------+
   | Official pay transparency policy | No. | %     |
   +==================================+=====+=======+
   | No policy                        | 490 | 52.2% |
   +----------------------------------+-----+-------+
   | Unsure                           | 224 | 23.9% |
...
Feelings abut pay transparency
------------------------------
...
.. table:: Feelings about pay transparency
   ...
   +---------------------------------+-----+-------+
   | Feelings about pay transparency | No. | %     |
   +=================================+=====+=======+
...
.. table:: Organization size - employees only
   ...
   +--------------------------------------------+-----+-------+
   | Organization size (by number of employees) | No. | %     |
   +============================================+=====+=======+
   | 101-1000                                   | 347 | 37.0% |
   +--------------------------------------------+-----+-------+
   | 1001-10,000                                | 261 | 27.8% |
   +--------------------------------------------+-----+-------+
...
.. container:: question
   ...
   Is this a multinational organization? Note: A multinational organization is defined as one that has office locations and business operations in two or more countries.
