...
.. |25| replace:: 25\ :sup:`th`

.. |50| replace:: 50\ :sup:`th`

.. |75| replace:: 75\ :sup:`th`
...
Where respondent numbers for individual US and Australian states, 
...
.. table::Salary (USD) by respondent region - Australian state
   :name: tbl-2023-salary-by-respondent-region-australian-state
   :class: std3col
...
Due to numbers, we are only able to break down salary by gender identity for women (59.9% of all respondents) and men (34.7% of all respondents). In every region, men earned more than women, by as much as XX% (in YY region).

.. raw:: html

   <div class="tab-wrap"><input type="radio" id="tabD33-1" name="tabGroupD33" class="tab" checked><label for="tabD33-1">Women</label><input type="radio" id="tabD33-2" name="tabGroupD33" class="tab"><label for="tabD33-2">Men</label><div class="tab__content">
